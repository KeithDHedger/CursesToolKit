...
enum {CUENTRYOK=5000,CUENTRYCANCEL,CUABOUTCLOSE,CUABOUTCREDITS,CUABOUTLICENCE,CUABOUTDONE,CUCHOOSEROK,CUCHOOSERSHOW,CUCHOOSERCANCEL,CUCHOOSERINPUT,CUQUERYOK,CUQUERYNO,CUQUERYCANCEL};
