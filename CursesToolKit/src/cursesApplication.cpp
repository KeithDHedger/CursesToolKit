...
*/
std::vector<varsStruct> CTK_mainAppClass::CTK_loadVars(const char *filepath)
{
...
*/
void CTK_mainAppClass::CTK_saveVars(const char *filepath,std::vector<varsStruct> vs)
{
	FILE	*fp;
